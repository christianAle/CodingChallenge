...
/****** Object:  Database [CodeChallenge]    Script Date: 13/01/2020 0:55:57 ******/
CREATE DATABASE [CodeChallenge]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CodeChallenge', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\CodeChallenge.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CodeChallenge_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\CodeChallenge_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
